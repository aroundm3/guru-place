...
export default function HighlightServiceGrid({
  ...
  return (
    <div className="grid lg:grid-cols-8 grid-cols-4 lg:gap-6 gap-4 bg-rose-300 px-4 py-5 lg:rounded-b-lg text-white">
      <div
        className="flex flex-col space-y-2 items-center hover:scale-105 duration-300 cursor-pointer"
        onClick={handleCategory}
      >
        <div className="flex rounded-full bg-rose-50 lg:w-14 w-12 aspect-square hover:bg-white cursor-pointer duration-300 text-rose-700">
          <CategoryRoundedIcon className="mx-auto my-auto" />
        </div>
        <span className="lg:text-sm text-xs font-semibold text-center mx-auto">
          Danh mục
        </span>
      </div>
