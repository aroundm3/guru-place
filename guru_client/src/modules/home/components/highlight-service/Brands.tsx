  ...
  return (
    <div className="relative flex flex-col bg-[#fffdf8] border pt-3 pb-4 border-stone-300 rounded-lg">
      ...
      <div className="relative">
        <button
          onClick={scrollLeft}
          className="absolute left-4 opacity-60 hover:opacity-100 duration-300 top-1/2 -translate-y-1/2 sm:block hidden z-10 p-2 bg-white rounded-full shadow-md hover:bg-gray-100"
        ...
        <button
          onClick={scrollRight}
          className="top-1/2 -translate-y-1/2 sm:block hidden absolute right-4 opacity-60 hover:opacity-100 duration-300 z-10 p-2 bg-white rounded-full shadow-md hover:bg-gray-100"
